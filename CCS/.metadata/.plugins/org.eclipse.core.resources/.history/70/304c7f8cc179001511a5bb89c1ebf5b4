...
#define MESSAGE_LENGTH		17	// must be less than or equal to MAX_APP_PAYLOAD	//
...
void transmitDataString(char addr[4],char rssi[3], char msg[MESSAGE_LENGTH] )
{
	...
	char output[] = {"ID=XXX.X,Vcc=X.XXX,T=XXX.XX,RH=XX.XX,Acc_x=XXXXX.XX,Acc_y=XXXXX.XX,Acc_z=XXXXX.XX,P=XXXX.XX,status=XXXXXXXX.X\r\n"};
