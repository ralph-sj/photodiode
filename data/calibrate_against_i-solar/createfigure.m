...
%  Auto-generated by MATLAB on 27-Oct-2015 23:10:53
...
% Create plot
plot1 = plot(X1,Y1,'Marker','.','LineStyle','none','DisplayName','data1');

% Create xlabel
xlabel('Vpd (V)');

% Create ylabel
ylabel('I_{solar} (\mu A)');

% Create title
title('Calibration of photodiode against solar current under halogen lamp');
% Get xdata from plot
